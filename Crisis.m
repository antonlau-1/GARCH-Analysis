...
returns = SP500HistoricalData2Crisis.LogDifference;
returns = returns(~isnan(returns));
returns = returns(:);

% Get the dates
dates = SP500HistoricalData2Crisis.Date;
dates = dates(~isnan(SP500HistoricalData2Crisis.LogDifference)); % Ensure dates match the non-NaN returns
