...
returns = SP500HistoricalData2024election.LogDifference;
returns = returns(~isnan(returns));
returns = returns(:);

% Get the dates
dates = SP500HistoricalData2024election.Date;
dates = dates(~isnan(SP500HistoricalData2024election.LogDifference)); % Ensure dates match the non-NaN returns
