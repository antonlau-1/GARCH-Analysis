...
returns = SP500HistoricalDatapostTrump.LogDifference;
returns = returns(~isnan(returns));
returns = returns(:);

% Get the dates
dates = SP500HistoricalDatapostTrump.Date;
dates = dates(~isnan(SP500HistoricalDatapostTrump.LogDifference)); % Ensure dates match the non-NaN returns
