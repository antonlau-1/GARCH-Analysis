...
returns = SP500PostCrisisHistorical.LogDifference;
returns = returns(~isnan(returns));
returns = returns(:);

% Get the dates
dates = SP500PostCrisisHistorical.Date;
dates = dates(~isnan(SP500PostCrisisHistorical.LogDifference)); % Ensure dates match the non-NaN returns
