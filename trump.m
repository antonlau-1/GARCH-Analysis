...
returns = SP500HistoricalDataTrump.LogDifference;
returns = returns(~isnan(returns));
returns = returns(:);

% Get the dates
dates = SP500HistoricalDataTrump.Date;
dates = dates(~isnan(SP500HistoricalDataTrump.LogDifference)); % Ensure dates match the non-NaN returns
